...
declare -A PKGSRC_MAP=(
    ...
    [5e4c3f98-aca4-11ee-9db8-00151714048c]=2023Q4
    [507e3476-7410-4020-a798-2b6e11ed099b]=2023Q4
)
...
declare -A SDC_MAP=(
    ...
    [5e4c3f98-aca4-11ee-9db8-00151714048c]=minimal-64-lts@23.4.0
    [507e3476-7410-4020-a798-2b6e11ed099b]=triton-origin-x86_64-23.4.0@master-20240212T184912Z-g4831e1f
)
...
declare -A JENKINS_AGENT_MAP=(
    ...
    [502eeef2-8267-489f-b19c-a206906f57ef]=6fc6ec02-a41a-4711-b811-27dc121d0396
)
...
function validate_opt_tools {
    # If we're using a modern release there's no need for /opt/tools
    if [[ "$PKGSRC_RELEASE" == "2023Q4" ]]; then
        return 0
